...
export class UpdateUserAndSessionEntities1751278248786
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "sessions" ADD "location" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "sessions" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "role" character varying DEFAULT 'user'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "sessions" ADD "user_id" uuid NOT NULL`,
    );
    await queryRunner.query(
